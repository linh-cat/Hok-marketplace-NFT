        ...
        <div className="cardhok">
            ...
            <div className="cardhok__body">
                ...
                {isMyNFT === true && <div className="cardhok__body--button">
                    {isCancel === true && <ButtonHok type="link" text="Cancel" color="#E06666" bold="bold" onClick={onClick}/>}
                    {isCancel === false && <form>
                        <input type="number" className='offer__input' placeholder='Offer price' value={priceOffer} onChange={EnterPrice}/>
                        <ButtonHok type="link" text="Offer" color="#009E0F" bold="bold" className='offer__btn' onClick={onClick}/>
                    </form>}
                </div>}
