...
import { accessories as ListAccessories ,
        arms as ListArms , 
        back as ListBack ,
        body as ListBody ,
        ...
        energy as ListEnergy} from '../../../components/Filter/List';
...
const Index = () => {
    ...
    const mintHandler = async () => {
        try {
            ...
            const formIsValid = capturedFileBuffer && arms && back && body && brain && deltoid && endo && energy;
            if(formIsValid) {
    ...
    return (
        <div className='form__new'>
            ...
            <Row>
                ...
                <ComboBoxHok options={ListAccessories} defaultValue={""} title="Accessories" width="180px" onChangeValue={enteredAccessories} values={accessories} />
                <ComboBoxHok options={ListArms} defaultValue={""} title="Arms" width="180px" onChangeValue={enteredArms} values={arms}/>
                <ComboBoxHok options={ListBack} defaultValue={""} title="Back" width="180px" onChangeValue={enteredBack} values={back}/>
                <ComboBoxHok options={ListBrain} defaultValue={""} title="Brain Shell" width="180px" onChangeValue={enteredBrain} values={brain}/>
                <ComboBoxHok options={ListEndo} defaultValue={""} title="Endoskeleton" width="180px" onChangeValue={enteredEndo} values={endo}/>
                <ComboBoxHok options={ListBody} defaultValue={""} title="Body" width="180px" onChangeValue={enteredBody} values={body}/>
                <ComboBoxHok options={ListDeltoid} defaultValue={""} title="Deltoid" width="180px" onChangeValue={enteredDeltoid} values={deltoid}/>
                <ComboBoxHok options={ListEnergy} defaultValue={""} title="Energy" width="180px" onChangeValue={enteredEnergy} values={energy}/>
